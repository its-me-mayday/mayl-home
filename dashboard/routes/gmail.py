...
def delete_messages(message_ids: list) -> tuple:
    ...
    try:
        ...
        # Invalida la cache del conteggio dopo una cancellazione
        if deleted > 0:
            invalidate_gmail_cache()
...
def invalidate_gmail_cache():
    """Forza il refresh del conteggio Gmail al prossimo /stats."""
    global _gmail_cache
    _gmail_cache['last_updated'] = 0
    print('[Gmail] Cache invalidata — prossimo /stats aggiornerà il conteggio')
